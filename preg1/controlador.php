...
if((isset($_GET['registrar']))&&(isset($_GET['pregunta']))){
...
// 	// =================
    ...
    $mt1 = $_GET['monto1'];
    include 'coneccion.php';
    $sql1 = "insert into tramites (`id`, `ci`, `operacion`, `monto`) values (null,'$ci','$op1','$mt1')";
		$result1 = mysqli_query($con,$sql1);

	$sql2 = "UPDATE profesional SET formulario = 'si' WHERE ci = '$ci'";
...
// if((isset($_GET['pago']))&&(isset($_GET['pregunta']))){
...
// 	$sql2 = "UPDATE profesional SET pago = 'si' WHERE ci = '$ci'";
// 	$result2 = mysqli_query($con,$sql2);
